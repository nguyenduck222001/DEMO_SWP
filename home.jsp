        ...
        <section class="events">
            <h2 class="events-title">Khuyến mãi</h2>
             <div class="event-container">
                <div class="row">
                    <c:forEach items="${listD}" var="Discounts">
                        <div class="col-md-4 mt-3">
                            <div class="card">
                                <a href="discount-details?DiscountID=${discount.id}">
                                    <img src="${discount.image}" class="card-img-top" alt="Discount Image">
                                </a>
                                <div class="card-body">
                                    <h5 class="card-title">${discount.code}</h5>
                                    <p class="card-text">Percentage $${discount.Percentage}</p>
                                </div>
                            </div>
                        </div>
                    </c:forEach>
